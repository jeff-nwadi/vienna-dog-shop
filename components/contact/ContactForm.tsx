...
export const ContactForm = () => {
  return (
    <div className="rounded-[10px] bg-white p-8 shadow-xl shadow-gray-100/50 border border-gray-50 md:p-12">
      <form className="flex flex-col gap-6 md:gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            className="w-full rounded-[10px] border-none bg-gray-50 p-5 text-[14px] text-brand-dark outline-none placeholder:text-gray-300 focus:ring-2 focus:ring-brand-green/20"
          />
        </div>

        <button className="h-14 w-full rounded-[10px] bg-brand-green px-8 font-bold text-white transition-all hover:brightness-110 active:scale-95 shadow-lg shadow-brand-green/10">
          Send Message
        </button>
      </form>
    </div>
